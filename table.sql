...
insert into forum_forum values('forum_cat_id', 'forum_name', 'auth_view', 'auth_post', 'forum_ordre', 'forum_last_post_id', 'forum_topic', 'forum_post', 'auth_topic', 'auth_annonce', 'auth_modo') values (1, "Forum", 1,2,50,0,0 ,0,2,3,4);
