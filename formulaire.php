 ...
 */
				...
				<?php
					...
					if(isset($_POST["inscription"])){ // Lors de la validation du formulaire
						if($check){ // Si les champs ont bien été remplis

							$nom = htmlspecialchars($_POST["nom"]);
							$prenom = htmlspecialchars($_POST["prenom"]);
							$email = htmlspecialchars($_POST["email"]);

							$mdp = sha1($_POST["mdp"]); // Cryptage des mots de passes
